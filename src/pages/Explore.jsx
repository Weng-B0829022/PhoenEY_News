  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(9)].map((_, i) => (
          <Link to={`/explore/news/${i + 1}`} key={i} className="bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
            <img src={`https://picsum.photos/300/200?random=${i}`} alt="News thumbnail" className="w-full h-full object-cover mb-2 rounded-lg" />
          </Link>
        ))}
      </div>
    </>
